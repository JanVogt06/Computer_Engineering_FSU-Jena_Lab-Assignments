...
\begin{enumerate}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|c|c|c|c|c|}
            ...
            \texttt{8'b1011\_1101} & \texttt{8'b1010\_0101} & \texttt{2'b10} & \texttt{8'b1010\_0101} & \texttt{1'b0} \\
            \texttt{8'b1011\_1101} & \texttt{8'b1010\_0101} & \texttt{2'b11} & \texttt{8'b1011\_1101} & \texttt{1'b0} \\
            \hline
        \end{tabular}
    \end{table}
